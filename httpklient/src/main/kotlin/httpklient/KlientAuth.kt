 ...
 * Hvis serveren svarer med en av [HttpKlientConfig.skipCacheRetryStatuses] (default `401`), gjør klienten ett nytt forsøk der [hentToken] kalles med `skipCache = true`, slik at et cachet token som ble avvist kan byttes ut med et ferskt.
...
sealed interface KlientAuth {
     ...
     * Ved avvist token (se [HttpKlientConfig.skipCacheRetryStatuses]) gjøres automatisk ett nytt forsøk med `hentToken(skipCache = true)`.
     */
