...
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.CircuitBreakerConfig.Companion.count
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.CircuitBreakerConfig.Companion.slidingWindow
 ...
 * State ligger i hver HttpKlient-instans, ikke statisk/globalt, og caches per [Enabled.name] for klientens levetid.
 ...
 *
 * [Enabled] er bygget på Arrow Resilience sin [arrow.resilience.CircuitBreaker] og eksponerer bevisst [TimeSource] direkte.
...
sealed interface CircuitBreakerConfig {
    ...
    data class Enabled(
        /**
         * Stabilt, lav-kardinalitet navn som identifiserer breaker-state innenfor én HttpKlient-instans.
