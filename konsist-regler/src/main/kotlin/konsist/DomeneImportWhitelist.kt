 ...
 *
 * `tillattePakker` er repoets egen liste og har ingen delt standard; `ekstraInfraSegmenter` legges til [InfraImport.standardInfraSegmenter].
 */
object DomeneImportWhitelist {
    ...
    fun assert(
        ...
        brudd(scope, erDomenepakke, tillattePakker, ekstraInfraSegmenter),
    ...
    private fun String.erTillatt(tillattePakker: Collection<String>, infraSegmenter: Set<String>): Boolean =
        !harSegmentI(infraSegmenter) && tillattePakker.any { pakke -> erLikEllerUnder(pakke) }
}
