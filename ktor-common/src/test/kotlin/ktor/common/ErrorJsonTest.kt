...
class ErrorJsonTest {
    ...
    @Test
    fun `respond403Forbidden returns 403 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond403Forbidden with ErrorJson returns 403 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond401Unauthorized returns 401 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond401Unauthorized with ErrorJson returns 401 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond500InternalServerError returns 500 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond500InternalServerError with ErrorJson returns 500 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond400BadRequest returns 400 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond400BadRequest with ErrorJson returns 400 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond404NotFound returns 404 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond404NotFound with ErrorJson returns 404 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond409Conflict returns 409 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond409Conflict with ErrorJson returns 409 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond501NotImplemented returns 501 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respond501NotImplemented with ErrorJson returns 501 with correct body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respondError with custom status returns correct status and body`() {
        testApplication {
            routing {
                get("/test") {
    ...
    @Test
    fun `respondError with ErrorJson returns correct response`() {
        testApplication {
            routing {
                get("/test") {
