 ...
 * Kjernegarantien er todelt: konsumenten får bytene eksakt som de kom på wire, mens metadata/feil ([no.nav.tiltakspenger.libs.httpklient.HttpKlientMetadata.rawResponseString], [HttpKlientError.ResponsMottatt.body]) forblir lesbar tekst som trygt kan sendes til sikkerlogg.
 */
