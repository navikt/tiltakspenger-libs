...
internal class JacksonKotlinTest {
    ...
    @Test
    fun `backtick-quotede property-navn round-tripper med backtick-navnet i JSON`() {
        // `is` er hardt reservert i Kotlin — backticks er eneste måten å bruke det som identifikator.
        // Vi forplikter oss til at JSON-feltet bruker selve identifikator-teksten ("is"), ikke noe ASCII-alias.
        roundTrip(
            MedBacktick(`is` = true, type = "B"),
            """{"is":true,"type":"B"}""",
        )
    }
