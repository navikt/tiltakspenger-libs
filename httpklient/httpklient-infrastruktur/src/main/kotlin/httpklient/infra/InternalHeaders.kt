 ...
 * Invariant: headeren kan aldri være satt fra før — [no.nav.tiltakspenger.libs.httpklient.infra.kall.Header] avviser reserverte navn, så klienten er alene om å skrive den.
 */
