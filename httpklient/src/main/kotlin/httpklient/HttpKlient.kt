 ...
 *
 * @param clock Klokken som brukes til veggklokke-tidsstempler ([HttpKlientMetadata.tidsstempler]). Påkrevd; ingen default i produksjonskode (se AGENTS.md).
...
internal fun byggHttpKlientRequest(
    ...
    val alleHeadere = buildMap<String, List<String>>(konsumentHeadere.size + 2) {
