 ...
 *
 * Trådsikker: all tilgang til den interne kø-/request-tilstanden er synkronisert på [lock], slik
 * at faken trygt kan deles mellom coroutines/tråder i parallelle tester (jf. at den virkelige
 * [HttpKlient] også kan brukes parallelt). Den køede handleren kjøres bevisst _utenfor_ låsen siden
 * den er `suspend`; selve opptaket av requesten og uttaket av handleren skjer atomisk under låsen.
 */
