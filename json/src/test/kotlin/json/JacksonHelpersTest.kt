...
internal class JacksonHelpersTest {
    ...
    @Test
    fun `deserializeMapNullable bevarer JSON-rekkefølge på nøkler`() {
        val resultat = deserializeMapNullable<String, Int>("""{"z":1,"a":2,"m":3}""")!!
        resultat.keys.toList() shouldBe listOf("z", "a", "m")
    }
