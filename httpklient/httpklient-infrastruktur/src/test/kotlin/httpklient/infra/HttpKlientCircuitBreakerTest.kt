...
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.CircuitBreakerOnRetryableErrors
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.CircuitBreakerOpeningStrategy
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.CircuitBreakerPredicate
import no.nav.tiltakspenger.libs.httpklient.infra.circuitbreaker.NeverRecordCircuitBreakerFailure
