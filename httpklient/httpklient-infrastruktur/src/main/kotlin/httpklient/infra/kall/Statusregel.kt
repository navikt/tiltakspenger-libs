 ...
 * En status som ikke godtas gir [no.nav.tiltakspenger.libs.httpklient.HttpKlientError.UventetStatus] med lesbar body og full metadata, som konsumenten kan utlede domenefeil fra (se [no.nav.tiltakspenger.libs.httpklient.HttpKlientError.harStatus] og [no.nav.tiltakspenger.libs.httpklient.HttpKlientError.ResponsMottatt.bodySomJson]).
 */
