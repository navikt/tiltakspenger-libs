...
data class Periode(
    ...
    infix fun slutterEtter(dato: LocalDate): Boolean = fraOgMed.isAfter(dato)
    ...
    /** Sjekker om denne perioden er før [other] (ingen overlapp) */
    infix fun før(other: Periode) = tilOgMed.isBefore(other.fraOgMed)

    /** Sjekker om denne perioden er etter [other] (ingen overlapp) */
