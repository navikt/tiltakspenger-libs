 ...
 * @param meldeperiodeKjedeId Identifiserer en meldeperiode, på tvers av saker. For øyeblikket på formatet yyyy-mm-dd/yyyy-mm-dd. Vil være unik sammen med [sakId]/[saksnummer] og [versjon]
 * @param versjon Versjon av meldeperioden. Øker med 1 for hvert nye vedtak dersom det påvirker meldeperioden. Unik sammen med [sakId]/[saksnummer] og [meldeperiodeKjedeId]
